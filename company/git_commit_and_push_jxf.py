...
def create_and_push_tag():
    ...
    subprocess.run(["open", "https://git.easydevops.net/frontend/jxf_web_static_vue/-/pipelines"])
    print("🌐 已自動開啟 GitLab 頁面：https://git.easydevops.net/frontend/jxf_web_static_vue/-/pipelines")
