...
def create_and_push_tag():
    ...
    subprocess.run("echo 'https://pt777web01.itomtest.com/mobile/app/fundsManage.jsp' | pbcopy", shell=True)
    print("📋 已自動複製網址到剪貼簿：https://pt777web01.itomtest.com/mobile/app/fundsManage.jsp")

    subprocess.run(["open", "https://git.easydevops.net/B2C_DC/pt777/web/-/pipelines"])
    print("🌐 已自動開啟 GitLab 頁面：https://git.easydevops.net/B2C_DC/pt777/web/-/pipelines")


def git_commit_and_tag():
    repo_path = "/Users/oncechen/IdeaProjects/c_pt777"
    os.chdir(repo_path)
